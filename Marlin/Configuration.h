...
//#define PSU_NAME "Power Supply"
  ...
  #define AUTO_POWER_CONTROL      // Enable automatic control of the PS_ON pin
    ...
    //#define AUTO_POWER_CHAMBER_TEMP  10 // (°C) Turn on PSU if the chamber is over this temperature
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 88.19
  #define DEFAULT_bedKi 6.90
  #define DEFAULT_bedKd 751.39
